    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('deliveries.show')" :active="request()->routeIs('deliveries.show')">
                        {{ __('Delivery History') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('clients.inactive')" :active="request()->routeIs('clients.inactive')">
                        {{ __('Inactive Clients') }}
                    </x-nav-link>
                </div>
            </div>
